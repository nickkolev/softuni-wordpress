<?php
// Simple file for my Dishes Custom Post Type
 ...
 * @return void
 */
function su_dish_category_taxonomy () {
    $labels = array(
        'name' => 'Categories',
...
add_action( 'init', 'su_dish_category_taxonomy');
 ...
 * @return void
 */
function dish_register_meta_boxes() {
	add_meta_box( 'featured', __( 'Is Featured?', 'softuni' ), 'dishes_featured_metabox_callback', 'dish', 'side' );
}
add_action( 'add_meta_boxes', 'dish_register_meta_boxes' );
 ...
 * @return void
 */
function dishes_featured_metabox_callback( $post_id ) {
 ...
 * @return void
 */
function dishes_meta_save ( $post_id ) {
...
add_action( 'save_post', 'dishes_meta_save'  );